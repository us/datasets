...
class TedMultiTranslateConfig(tfds.core.BuilderConfig):
  """BuilderConfig for TedMultiTranslate."""
  ...
  def __init__(self, **kwargs):
    ...
    """
    super(TedMultiTranslateConfig, self).__init__(**kwargs)
